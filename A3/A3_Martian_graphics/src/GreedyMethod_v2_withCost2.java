...
public class GreedyMethod_v2_withCost2 extends Rover {
	...
	public GreedyMethod_v2_withCost2(int startX, int startY, double startingBattery, Environment estimatedEnv) {
