...
public class GreedyMethod_v2_withCost extends Rover {
	...
	private int steps;
	private double homePdf[][];

	public GreedyMethod_v2_withCost(int startX, int startY, double startingBattery, Environment estimatedEnv) {
		...
		EnvironmentBuilder.setGaussianPdf(homePdf, home.x, home.y, 100);
		printArray(homePdf);
	...
	public ArrayList<Point> goingHome2()
